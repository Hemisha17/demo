  ...
  $qu="select * from tbl_product where `product_image`='$product_image'";
   ...
   $qu1 = mysqli_query($con,$qu);
    ...
    { 
       ...
       $que="insert into tbl_cart(`cart_product_id`,`cart_customer_id`,`cart_qty`,`cart_total_amount`,`cart_status`)values('$selectsize','$customer_id','$qty','$total_amt','pending')";
      ...
      if(isset($_POST['wishlist']))
      {
         ...
         $wq="select * from tbl_wishlist where `wishlist_product_id`='$product_id'";
         $wq1=mysqli_query($con,$wq);
         $wnum=mysqli_num_rows($wq1);
         if($wnum==0)
         {
          $wque="insert into tbl_wishlist(`wishlist_product_id`,`wishlist_customer_id`)values('$product_id','$customer_id')";
          $wque1=mysqli_query($con,$wque);
                            ...
                            <div class="product-details">
                                   ...
                                   <div class="sc-item">
                                      ...
                                      <select name="selectsize" style="width:300px;height: 30px;background-color:#F8F8FF;border-radius: 5px;padding-left: 20px;" id="size">
                                        ...
                                        <?php while($qu2=mysqli_fetch_array($qu1)){ ?>
                                          ...
                                          <option value="<?php  echo $qu2['product_id']; ?>" >
                                ...
                                <div class="quantity">
                                     ...
                                     <?php if(isset($_SESSION['customer_data'])) { ?> 
                                      ...
                                      <button type="submit" name="cart" id="cart" class="primary-btn pd-cart" style="width: 400px;">
                                        <i class="fa fa-shopping-cart" style="font-size: 25px;"></i> 
                                            &nbsp;&nbsp;Add To Cart
                                     </button>
                                     <?php } else { ?>

                                    <a href="login.php" class="primary-btn pd-cart" name="cart" onclick="return gotologin()">
                                       <i class="fa fa-shopping-cart" style="font-size: 25px;"></i> 
                                    &nbsp;&nbsp;Add To Cart
                                    </a> 
